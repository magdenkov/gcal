...
//    private static final String CLIENT_SECRET_DIR = "client_service_secret.json";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = CalendarUpdateTimeZone.class.getResourceAsStream(CLIENT_SECRET_DIR);
...
//        System.out.println("Calendar summary " +  createdCalendarListEntry.getSummary());
        ...
        Event event = new Event()
                .setSummary("Testing api from console ")
//                .setColorId("#fa573c")
                .setLocation("800 Howard St., San Francisco, CA 94103")
                .setDescription("A chance to hear more about Google's developer products.");

        DateTime startDateTime = new DateTime("2018-05-14T09:00:00-07:00");
        EventDateTime start = new EventDateTime()
                .setDateTime(startDateTime)
                .setTimeZone("America/Los_Angeles");
        event.setStart(start);

        DateTime endDateTime = new DateTime("2018-05-14T17:00:00-07:00");
